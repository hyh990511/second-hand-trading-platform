<template>
    <div>
            <el-backtop  :bottom="200" :visibility-height="60" :right="400">
        ...
        <div class="show">
            <el-row :gutter="40">
                ...
                <el-col class="searchResult" :span="19">
                            ...
                            <el-col>
                                <el-form-item>
                                    ...
                                    <el-button type="primary"
                                               @click="goSearch(keywordForm.goods)" style="margin-left: 20px;">搜索
                                    </el-button>
                                </el-form-item>
                            </el-col>
                        </el-row>
                    ...
                    <!--                    提示语                    -->
                    <div v-if="isSearch === 0">
                        <div class="noInfo" v-if="goodsList.length === 0">很抱歉，该专区暂时没有在售商品，您可以到其它专区逛逛</div>
                    </div>
                    <div v-if="isSearch === 1">
                        <div class="prompt" v-if="totalGoods !== 0"><i class="el-icon-search" style="float: left;font-size: 30px"></i>共查询到{{totalGoods}}件商品,结果如下</div>
                        <div class="noInfo" v-if="totalGoods === 0">很抱歉，没有找到与“{{keyword}}”相关的商品，您可以尝试换个关键词搜索</div>
                    </div>
                    <div class="prompt" v-if="isSearch === 0">
                        <span style="float: left;font-weight: bolder;margin-left: 10px;">为您推荐的商品:</span>
                    </div>
                    <br>
                    <!--                    分割线                    -->
                                ...
                                <div class="cardContent">
                                    ...
                                    <div class="infoArea">
                                        <div style="width: 240px; margin: 3px">
                                            <el-row>
                                                <el-col :span="16">
                                                    <div class="price">想换的书：{{goods.exchangeBook}}</div>
                                                </el-col>
                                                <el-col :span="8">
                ...
                <el-col class="hotGoods" :span="5">
                    <div class="prompt">
                        ...
                        <span style="float: left;font-weight: bolder;margin-left: 10px;">热搜商品</span>
                    </div>
                    <!--                    分割线                    -->
    ...
    export default {
        data() {
            return {
                ...
                goodsList: [],
                imgList:{
                    url1:'https://images.pexels.com/photos/159581/dictionary-reference-book-learning-meaning-159581.jpeg?cs=srgb&dl=pexels-159581.jpg&fm=jpg',
                    url2:'https://images.pexels.com/photos/5946/books-yellow-book-reading.jpg?cs=srgb&dl=pexels-5946.jpg&fm=jpg',
                    url3:'https://images.pexels.com/photos/3747502/pexels-photo-3747502.jpeg?cs=srgb&dl=pexels-3747502.jpg&fm=jpg'
                },
                hotList: [],
            ...
            // 点击本页先随机展示属于本专区的商品
             ...
             axios.post(_this.GLOBAL.host+'goods/init/'+_this.pageSize+'/'+
                  _this.ascription).then(function (resp) {
                     ...
                     let total=_this.goodsList.length
